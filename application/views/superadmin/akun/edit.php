                        ...
                        <form method="post" action="<?php echo base_url('superadmin/update_akun/?id=' . $edit['id']); ?>" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="nik" name="nik" value="<?= $edit['nik']; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="contact">Contact</label>
                                    <input type="number" class="form-control" id="contact" name="contact" value="<?= $edit['contact']; ?>" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="role_id" id="role_id">
                                        ...
                                        <option <?php if ($edit['role_id'] == "3") {
                                                    echo 'selected';
                                                } ?> value="3">User (Masyarakat)</option>
                                    </select>
                                </div>
                                <div class="form-group">
